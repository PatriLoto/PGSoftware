---
title: "Plan de Gestión de Software - Asistente virtual para Ciencia Abierta"
...
- `renv` para gestión de dependencias en R - Docker para containerización 
- `conda` environments para Python - Virtual environments
...
**Estándares:** - Uso de docstrings/roxygen2 en cada función 
